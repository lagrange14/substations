    ...
    public abstract class SharedShowerSystem : EntitySystem
    {
        ...
        private void UpdateAppearance(EntityUid uid, ShowerComponent? component = null)
        {
            ...
            if (component.ToggleShower)
            {
                ...
                {
                    var audio = _audio.PlayPvs(component.LoopingSound, uid, AudioParams.Default.WithLoop(true).WithMaxDistance(5)); // L5 I'm manually copying a downstream fix from the den
