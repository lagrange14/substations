# L5
job-description-medical-borg = An intelligence in a robotic chassis. Follow your chassis' laws, serve the crew, and assist the medical department.
...
job-description-security-borg = Purpose-built to ensure the right of every crew member to liberty, justice and freedom, ensure the peace aboard the space station by following your directives and patrolling the halls.
# L5
job-description-roboticist = Fabricate various robotic chassis and other robots, repair and upgrade the station's silicon life, and scream "State Directives" when the SSR takes too long to open a door.
...
job-description-admin-assistant = Assist command in their day-to-day activities, grab the station admin a coffee, answer faxes in the bridge.
